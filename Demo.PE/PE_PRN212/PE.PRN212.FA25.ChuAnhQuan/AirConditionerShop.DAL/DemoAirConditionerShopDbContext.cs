...
public partial class DemoAirConditionerShopDbContext : DbContext
{
    public DemoAirConditionerShopDbContext()
    {
    }

    public DemoAirConditionerShopDbContext(DbContextOptions<DemoAirConditionerShopDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AirConditionerId).HasName("PK__AirCondi__EE2EB73998CB8648");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__StaffMem__0CF04B38DB2D2AC5");

            entity.ToTable("StaffMember");

            entity.HasIndex(e => e.EmailAddress, "UQ__StaffMem__49A147404DC64AD2").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B43F95D0AC");
